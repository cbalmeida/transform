...
class GetProdutoAllRouteOutput extends TransformRouteOutputJson {
  ...
  @override
  Map<String, dynamic> get output => {"produtos": produtos.map((e) => e.toMap()).toList()};
}
...
class GetProdutoAllRouteHandler extends TransformRouteHandler<GetProdutoAllRouteInput, GetProdutoAllRouteOutput> {
  ...
  GetProdutoAllRouteHandler({required this.getProdutoAllUseCase, required super.jwt, required super.limiter});
